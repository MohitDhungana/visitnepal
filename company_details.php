...
<div class="panel panel-default" align="center">
  <div class="panel-heading" align="center">  <h4 align="center">Company Info</h4></div>
   <div class="panel-body" align="center">
    ...
    <div class="box box-info" align="center">
            ...
            <div class="col-sm-6">
              ...
              <?php
                ...
                if (isset($_GET['companies_id'])) {
                    $the_companies_id = $_GET['companies_id'];
                }
                // $the_companies_id = $_GET['companies_id'];

                $companies_query = "SELECT * FROM companies WHERE id={$the_companies_id}";
                $select_companies = mysqli_query($connection, $companies_query);

                $row = mysqli_fetch_assoc($select_companies);
                $companies_id = $row['id'];
                $companies_name = $row['name'];
                $companies_email = $row['email'];
                $companies_contact = $row['contact'];

                $package_query = "SELECT * FROM package WHERE companies_id={$companies_id}";
                $select_package = mysqli_query($connection, $package_query);
                $package_row = mysqli_fetch_assoc($select_package);
            ...
            <ul class="list-group" style="font-size: 120%;"  >
                          <li class="list-group-item"><strong>Company Name: </strong><?php echo ($companies_name) ?></li>
                          <li class="list-group-item list-group-item-success"></li>
                           <li class="list-group-item"><strong>Email: </strong><?php echo ($companies_email) ?></li>
                          <li class="list-group-item list-group-item-info"></li>
                          <li class="list-group-item"><strong>Contact: </strong>$ <?php echo ($companies_contact) ?></li>
